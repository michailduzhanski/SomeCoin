...
#include "arnak/JoinSplit.hpp"
#include "arnak/Note.hpp"
#include "arnak/NoteEncryption.hpp"
...
TEST(WalletTests, SpentSaplingNoteIsFromMe) {
    ...
    // *** Error in `./arnak-gtest': double free or corruption (out): 0x00007ffd8755d990 ***
    anchor = saplingTree.root();
