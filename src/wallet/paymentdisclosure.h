...
#ifndef ARNAK_PAYMENTDISCLOSURE_H
#define ARNAK_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // arnak/NoteEncryption.cpp
...
struct PaymentDisclosurePayload {
    ...
    libzcash::SproutPaymentAddress zaddr; // arnak/Address.hpp
...
#endif // ARNAK_PAYMENTDISCLOSURE_H
