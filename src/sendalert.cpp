// Copyright (c) 2016-2018 The Arnak developers
...
./arnakd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.nID           = 1006;  // use https://github.com/michailduzhanski/arnak/wiki/specification#assigned-numbers to keep track of alert IDs
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and incompatible with the Sapling network upgrade. Please update to a recent version of Arnak (2.0.1 or later).";
