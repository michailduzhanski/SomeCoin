...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Arnak
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Arnak
    // Mac: ~/Library/Application Support/Arnak
    // Unix: ~/.arnak
#ifdef WIN32
    // Windows
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override arnak.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "arnakd.pid"));
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i The Arnak Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
