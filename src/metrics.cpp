// Copyright (c) 2016 The Arnak developers
...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your arnak.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
    }
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("arnak-metrics-screen");
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << strprintf(_("Thank you for running a %s Arnak node!"), WhichNetwork()) << std::endl;
