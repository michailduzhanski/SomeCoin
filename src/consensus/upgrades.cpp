...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
    {
        /*.nBranchId =*/ 0,
        /*.strName =*/ "Sprout",
        /*.strInfo =*/ "The Arnak network at launch",
    },
    {
    ...
    },
    {
        ...
        /*.strName =*/ "Overwinter",
        /*.strInfo =*/ "See https://arnak.org/upgrade/overwinter.html for details.",
    },
    {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Sapling",
        /*.strInfo =*/ "See https://arnak.org/upgrade/sapling.html for details.",
    },
    {
        /*.nBranchId =*/ 0x2bb40e60,
        /*.strName =*/ "Blossom",
        /*.strInfo =*/ "See https://arnak.org/upgrade/blossom.html for details.",
    }
};
