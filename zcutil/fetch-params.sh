...
Failed to fetch the Arnak zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
Arnak - fetch-params.sh

This script will fetch the Arnak zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Arnak zkSNARK parameters. Note that it is
