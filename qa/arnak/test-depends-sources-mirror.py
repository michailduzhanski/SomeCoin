...
# This script tests that the package mirror at https://download.arnak.org/depends-sources/
# contains all of the packages required to build this version of Arnak.
#
# This script assumes you've just built Arnak, and that as a result of that
...
MIRROR_URL_DIR="https://download.arnak.org/depends-sources/"
