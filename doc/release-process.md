...
If this is a hotfix release, please see the [Hotfix Release Process](https://github.com/michailduzhanski/arnak/blob/master/doc/hotfix-process.md) documentation before proceeding.
...
Push the resulting branch to github:
    ...
    $ git push 'git@github.com:$YOUR_GITHUB_NAME/arnak' $(git rev-parse --abbrev-ref HEAD)
...
- Go to the [GitHub tags page](https://github.com/michailduzhanski/arnak/tags).
...
Then, verify that nodes can connect to the testnet server, and update the guide on the wiki to ensure the correct hostname is listed in the recommended arnak.conf.

### Update the 1.0 User Guide

This also means updating [the translations](https://github.com/michailduzhanski/arnak-docs).
Coordinate with the translation team for now. Suggestions for improving this
part of the process should be added to #2596.

### Publish the release announcement (blog, github, arnak-dev, slack)
