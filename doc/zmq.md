...
router", implementing the Arnak wire protocol and relay, making
...
The ZeroMQ feature in Arnak requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ arnakd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/arnakd.tx.raw
...
From the perspective of arnakd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into arnakd directly. Furthermore, no information is
...
using. Arnakd appends an up-counting sequence number to each
