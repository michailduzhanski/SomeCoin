...
Jack Grigg (31):
      ...
      Rename libbitcoinconsensus to libarnakconsensus
      Rename bitcoin-tx to arnak-tx
...
Jay Graber (7):
      Rm bitcoin dev keys from gitian-downloader, add arnak dev keys
      Rm bips.md
      Update files.md for arnak
