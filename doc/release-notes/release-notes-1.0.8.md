...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to arnakd by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for arnakd -help.
...
Jay Graber (5):
      ...
      Add security warning to arnak-cli --help and --version message output
      Add security warning to arnakd metrics display
...
Sean Bowe (2):
      Introduce librustarnak and Rust to depends system.
