...
`migration=1` in the `arnak.conf` file. Unless otherwise specified funds will be
...
For a complete list of changes in 2.0.5, 2.0.5-1 and 2.0.5-2, see the [2.0.5 milestone](https://github.com/michailduzhanski/arnak/milestone/79?closed=1).
