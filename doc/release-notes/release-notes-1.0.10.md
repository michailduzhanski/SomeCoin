...
ECDSA signatures inside Arnak transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to Arnak.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in arnak-gtest
