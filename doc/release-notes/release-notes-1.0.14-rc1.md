...
[the Arnak protocol spec](https://github.com/arnak/zips/blob/master/protocol/protocol.pdf),
...
- **Caution:** for z-addresses, these balances will **not** be accurate if any
  ...
  (e.g. [#2542](https://github.com/michailduzhanski/arnak/issues/2542)).
...
Jack Grigg (36):
      ...
      build: Split hardening/fPIE options out in Arnak-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move Arnak flags into configure.ac
      ViewingKey -> ReceivingKey per arnak/zips#117
      ...
      Add watch-only support to Arnak RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to arnak and not bitcoin.
